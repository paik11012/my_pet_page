# Generated by Django 3.0 on 2019-12-18 01:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('liked_items', models.ManyToManyField(related_name='liked_users', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='item', to='memories.Genre')),
                ('liked_users', models.ManyToManyField(blank=True, related_name='liked_item', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Article',
